  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/admin/blog/edit/:id" element={<PrivateRoute requireAdmin><BlogEditor /></PrivateRoute>} />
        <Route path="/login" element={<Login />} />
        <Route path="/maintenance" element={<Maintenance />} />
        <Route path="/account" element={<PrivateRoute><Account /></PrivateRoute>} />
        <Route path="/amnezia-tech" element={<AmneziaWG />} />
        <Route path="/amneziawg" element={<AmneziaWG />} />
        ...
        <Route path="/admin/servers/:id" element={<PrivateRoute requireAdmin><ServerDetails /></PrivateRoute>} />
